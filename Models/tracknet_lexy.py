...
Original file is located at
    https://colab.research.google.com/drive/1j8zRvu_8oQWu6Yj6YHo2v1Rbb1P7Gh8I
"""
...
for test_cell in tqdm(cell_ids, desc="cross validation"):
    ...
    model = VGG16_TrackNet().to(device)  # model_name must be 'TrackNet', 'VGG16_TrackNet', or 'ResNet34_TrackNet'
